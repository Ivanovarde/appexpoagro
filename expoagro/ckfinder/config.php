...
$config['ResourceType'][] = Array(
		...
		'directory' => $baseDir . 'imagenes',
		'maxSize' => "16M",
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,avi,iso,pdf',
		'deniedExtensions' => '');
